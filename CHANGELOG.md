...
- Added compatibility-safe WorkUnit v2 plus a canonical Agent Work lifecycle policy with terminal/recovery semantics, contiguous plan/retry history, transition-checked replay, derived progress, and success/blocked/failed/retried/replanned fixtures.
