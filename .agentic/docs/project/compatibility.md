...
The [production-core CLI contracts](cli-contracts.md) specify audit v2 null semantics, legacy artifact reads, input/exit behavior, expiry dates, installation guarantees, and composition preservation. The legacy codebase-audit schema remains unchanged.
