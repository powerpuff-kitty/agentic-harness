...
Reload resets state; there is deliberately no recovery after reload. Adding recovery/persistence or telemetry requires a reviewed product/security decision. Browser tests inspect escaped markup, link isolation, requests, cookies, storage, caches and service workers during the tested journey. That bounded observation does not establish absence of all possible leaks. Dependencies are pinned; vulnerability and comprehensive supply-chain review remain separate from these functional checks.
