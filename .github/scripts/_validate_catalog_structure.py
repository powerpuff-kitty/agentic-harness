...
validate_target(ROOT / ".agentic/evals/fixtures/adoption/reading-list", "web-app")
...
required_schemas = {"manifest.schema.json", "lock.schema.json", "variant.schema.json", "adr-index.schema.json", "migration-report.schema.json", "codebase-audit.schema.json", "profile.schema.json", "architecture-graph.v1.schema.json", "architecture-analysis.v1.schema.json", "architecture-derivatives.v1.schema.json", "architecture-drift.v1.schema.json", "architecture-reference.v1.schema.json"}
